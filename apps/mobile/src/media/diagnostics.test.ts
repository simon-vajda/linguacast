...
/**
 * The verdict is what drives the Channel screen's session restart, and it has to survive the
 * narration around it being compiled out. Each case therefore runs twice, once per build flag.
 */
